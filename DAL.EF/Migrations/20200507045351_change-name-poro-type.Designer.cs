...
namespace DAL.EF.Migrations
{
    ...
    [Migration("20200507045351_change-name-poro-type")]
    partial class changenameporotype
    {
            ...
            modelBuilder.Entity("Domain.Aggregate.DomainAggregates.CategoryAggregate.CategoryProperty", b =>
                {
                    ...
                    b.OwnsOne("Domain.Aggregate.DomainAggregates.CategoryAggregate.CategoryTypeProp", "CategoryPropertyType", b1 =>
                        {
                            b1.Property<Guid>("CategoryPropertyId")
                                .HasColumnType("uniqueidentifier");

                            b1.Property<int>("CategoryPropertyType")
                                .HasColumnName("CategoryPropertyType")
                                .HasColumnType("int");

                            b1.HasKey("CategoryPropertyId");

                            b1.ToTable("CategoryProperty");
